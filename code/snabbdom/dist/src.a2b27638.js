...
var patch = (0, _snabbdom.init)([_class.default, _eventlisteners.default, _style.default, _props.default]);
var vnode;
var nextKey = 11;
var margin = 8;
var sortBy = 'rank';
...
var data = [originalData[0], originalData[1], originalData[2], originalData[3], originalData[4], originalData[5], originalData[6], originalData[7], originalData[8], originalData[9]]; // 根据prop排序
...
function add() {
  ...
  var n = originalData[Math.floor(Math.random() * 10)]; // 添加数据
...
function movieView(movie) {
  ...
  }, movie.rank), (0, _snabbdom.h)('div', movie.title), (0, _snabbdom.h)('div', movie.desc), (0, _snabbdom.h)('div.btn.rm-btn', {
    on: {
      click: [remove, movie]
    }
  }, 'x')]);
...
function render() {
  ...
  console.log(data[data.length - 1]); // 处理删除所以内容报错的问题
...
function view(data) {
  return (0, _snabbdom.h)('div', [(0, _snabbdom.h)('h1', 'Top 10 movies'), (0, _snabbdom.h)('div', [(0, _snabbdom.h)('a.btn.add', {
    on: {
      click: add
    }
  }, 'Add'), 'Sort by: ', (0, _snabbdom.h)('span.btn-group', [(0, _snabbdom.h)('a.btn.rank', {
    class: {
      active: sortBy === 'rank'
    },
    on: {
  ...
  }, 'Rank'), (0, _snabbdom.h)('a.btn.title', {
    class: {
      active: sortBy === 'title'
    },
    on: {
  ...
  }, 'Title'), (0, _snabbdom.h)('a.btn.desc', {
    class: {
      active: sortBy === 'desc'
    },
    on: {
  ...
  }, 'Description')])]), (0, _snabbdom.h)('div.list', {
    style: {
...
},{"snabbdom":"node_modules/snabbdom/es/snabbdom.js","snabbdom/modules/class":"node_modules/snabbdom/modules/class.js","snabbdom/modules/eventlisteners":"node_modules/snabbdom/modules/eventlisteners.js","snabbdom/modules/style":"node_modules/snabbdom/modules/style.js","snabbdom/modules/props":"node_modules/snabbdom/modules/props.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
